...
| **Pollution Level Spatial Prediction (Regression)** | **Toxic Tide Mapping** |Map predicted pollution intensity across space using ML regression, interpolated grids, lagged squid catch, SST, SSH, and Chlorophyll-a, and upstream human activity (industrial & agricultural pressures) to identify areas where contaminants may impact marine life. | 🟢 Planned | 🧪 Pollution & Marine Health Explorer |
